...
obtiene la frecuencia de cada una de las calificaciones y además escribe cuál es la frecuencia más alta.
*/
...
void Lectura(int VEC[], int T) {
    int I;
    for (I = 0; I < T; I++) {
        printf("Ingrese la calificacion - 0 a 5 - del alumno %d: ", I + 1);
        scanf("%d", &VEC[I]);
    }
}
